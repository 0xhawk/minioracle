...
export const protobufPackage = "minioracle.minioracle";
...
export class QueryClientImpl implements Query {
  ...
  Posts(request: QueryPostsRequest): Promise<QueryPostsResponse> {
    ...
    const promise = this.rpc.request("minioracle.minioracle.Query", "Posts", data);
  ...
  Comment(request: QueryGetCommentRequest): Promise<QueryGetCommentResponse> {
    ...
    const promise = this.rpc.request("minioracle.minioracle.Query", "Comment", data);
  ...
  CommentAll(request: QueryAllCommentRequest): Promise<QueryAllCommentResponse> {
    ...
    const promise = this.rpc.request("minioracle.minioracle.Query", "CommentAll", data);
