...
export interface MinioracleComment {
  /** @format uint64 */
  id?: string;
  creator?: string;
  title?: string;
 ...
 */
export type MinioracleParams = object;

export interface MinioraclePost {
  creator?: string;
...
export interface MinioracleQueryAllCommentResponse {
  Comment?: MinioracleComment[];
...
export interface MinioracleQueryGetCommentResponse {
  Comment?: MinioracleComment;
}
...
/**
 * @title minioracle/minioracle/comment.proto
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/minioracle/minioracle/comment
   */
  queryCommentAll = (
    query?: {
    ...
    this.request<MinioracleQueryAllCommentResponse, RpcStatus>({
      path: `/minioracle/minioracle/comment`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/minioracle/minioracle/comment/{id}
   */
  queryComment = (id: string, params: RequestParams = {}) =>
    this.request<MinioracleQueryGetCommentResponse, RpcStatus>({
      path: `/minioracle/minioracle/comment/${id}`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/minioracle/minioracle/params
   */
